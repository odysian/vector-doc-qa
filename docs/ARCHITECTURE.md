...
- **Cutover governance:** Production rollout identity is the tuple (`vm_image` as image version + `reconcile_release_id`) with mandatory checkpoint, health gates, and rollback drill evidence in `docs/GCP_RUNBOOK.md` (decision rationale: `docs/adr/008-vm-golden-image-cutover-and-tuple-rollback.md`).
